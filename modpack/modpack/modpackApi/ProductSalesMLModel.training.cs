...
{
    public partial class ProductSalesMLModel
    {
        public const string RetrainFilePath =  @"C:\Users\User\Downloads\客戶分群表 - 工作表1 (1).csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(@"id", @"id")      
                                    ...
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"id",@"Month"}))      
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=4,FeatureFraction=1F,LabelColumnName=@"ProductSales",FeatureColumnName=@"Features"}));
